...
<body style="background: lightgray;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" name="title" rows="5"
    ...
    <script serc="https://cdn.ckeditor.com/4.13.1/standard/ckeditor"></script>
